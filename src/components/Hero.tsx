  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-white pt-20">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight text-gray-900 mb-16 leading-[0.85] tracking-tight">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg md:text-xl text-gray-600 font-light leading-relaxed mb-8">
            ...
            hire, fundraise, and partner with the best talent in the world.
          </p>
        </div>
      </div>
    </section>
