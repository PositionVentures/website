...
export default function Team() {
  return (
    <section id="team" className="pt-16 pb-16 bg-gray-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm leading-relaxed font-light max-w-sm mx-auto mb-6">
              I spent my entire career working hand‑in‑hand with hundreds of founders on their positioning and communications strategy, partnering with everyone from trailblazing first‑time founders to some of the most iconic founders of our lifetime. I started Position Ventures to help industry‑defining founders share their stories.
            </p>
